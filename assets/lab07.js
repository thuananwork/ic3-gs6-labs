    ...
    const TERMS$1 = [
        {
          id: 1,
          name: "Breadcrumb",
          icon: jsxRuntimeExports.jsx(FolderTree, { className: "h-5 w-5" }),
          color: "from-blue-500 to-cyan-500",
          desc: "Thanh định vị sơ đồ phân cấp đường dẫn trang web.",
        },
        {
          id: 2,
          name: "Nhà mạng ISP",
          icon: jsxRuntimeExports.jsx(Globe, { className: "h-5 w-5" }),
          color: "from-purple-500 to-indigo-500",
          desc: "Nhà cung cấp dịch vụ kết nối Internet đường truyền.",
        },
        {
          id: 3,
          name: "Cookie",
          icon: jsxRuntimeExports.jsx(Cookie, { className: "h-5 w-5" }),
          color: "from-amber-500 to-orange-500",
          desc: "Tập tin văn bản nhỏ lưu dấu hoạt động trình duyệt.",
        },
        {
          id: 4,
          name: "Ngôn ngữ HTML",
          icon: jsxRuntimeExports.jsx(Code, { className: "h-5 w-5" }),
          color: "from-rose-500 to-pink-500",
          desc: "Ngôn ngữ đánh dấu siêu văn bản định hình cấu trúc web.",
        },
        {
          id: 5,
          name: "Máy chủ DNS",
          ...
          desc: "Hệ thống phân giải tên miền thành địa chỉ IP.",
        },
      ],
      DEFINITIONS$1 = [
        {
          id: 1,
          text: "Cho phép người dùng truy xuất lại các bước của họ trên một trang web",
          correctTermId: 1,
        },
        {
          id: 2,
          text: "Một công ty kết nối người dùng với internet",
          correctTermId: 2,
        },
        {
          id: 3,
          text: "Một tập tin văn bản theo dõi hoạt động của người dùng trên một trang web",
          correctTermId: 3,
        },
        {
          id: 4,
          text: "Một ngôn ngữ đánh dấu được sử dụng để tạo các trang web",
          correctTermId: 4,
        },
        {
          id: 5,
          text: "Một thư mục phân cấp ánh xạ vị trí của các tài nguyên trên internet",
          correctTermId: 5,
        },
      ];
